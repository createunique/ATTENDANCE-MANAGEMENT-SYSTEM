...
<body>
    <div class="container">
        <div class="right-half">
            ...
            <!-- Add this button below the "Save Attendance D" button -->
            <button class="btn-menu" onclick="redirectToUpdateAttendance()">Update Attendance</button>
    ...
    <script>
        ...
        function redirectToUpdateAttendance() {
            window.location.href = 'update_attendance_page.php';
        }
